...
function updateResumeContent(data: ResumeData): void {
    ...
    updateInnerHTML('resumeFacebook', `<span class="pic a"></span> <a href="${data.facebook}">Facebook</a>`);
    updateInnerHTML('resumeTwitter', `<span class="pic b"></span> <a href="${data.twitter}">Twitter</a>`);
    updateInnerHTML('resumeLinkedIn', `<span class="pic d"></span> <a href="${data.linkedin}">LinkedIn</a>`);
    updateInnerHTML('resumeYouTube', `<span class="pic c"></span> <a href="${data.youtube}">YouTube</a>`);
    ...
    if (profileImageInput && profileImageInput.files && profileImageInput.files[0]) {
        ...
        reader.onload = function (e: ProgressEvent<FileReader>) {
            ...
            const formData: ResumeData = {
                ...
                html: parseInt((document.getElementById('html') as HTMLInputElement).value),
                css: parseInt((document.getElementById('css') as HTMLInputElement).value),
                javascript: parseInt((document.getElementById('javascript') as HTMLInputElement).value),
                react: parseInt((document.getElementById('react') as HTMLInputElement).value),
                nextjs: parseInt((document.getElementById('nextjs') as HTMLInputElement).value),
